...
const TermsOfUse = () => {
  return (
    ...
    />
    <div data-custom-class="body" style={{maxWidth:'1000px', margin:"auto"}}>
            ...
            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
              <span style={{ fontSize: 15 }}>
                <a data-custom-class="link" href="#disclaimer">
                  <span style={{ color: "rgb(89, 89, 89)" }}>20. DISCLAIMER</span>
                </a>
              </span>
            </div>
            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
              <span style={{ fontSize: 15 }}>
                <a data-custom-class="link" href="#userdata">
                  <span style={{ color: "rgb(89, 89, 89)" }}>23. USER DATA</span>
                </a>
              </span>
            </div>
            <div style={{ lineHeight: "1.5", textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <a
                  href="https://living-memory.xyz/"
                  target="_blank"
                  data-custom-class="link"
                >
                  https://living-memory.xyz/
                </a>
              </bdt>{" "}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <bdt classname="question">Israel</bdt>
                      <bdt classname="statement-end-if-in-editor">
                        <span
                          style={{
                            fontSize: "11.0pt",
                  ...
                  <bdt classname="question">bney geulim 7</bdt>
                  <bdt classname="block-component" />
                </span>
              </span>
              , <bdt classname="question">kfar yedidiya</bdt>
            </span>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <bdt classname="block-component" />,{" "}
                      <bdt classname="question">sharon</bdt>
                      <bdt classname="statement-end-if-in-editor" />
                      <bdt classname="block-component" />{" "}
                      <bdt classname="question">42940</bdt>
                      <bdt classname="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
                ...
                <bdt data-type="body">
                  <ul>
                    <li
                      ...
                      style={{ lineHeight: "1.5", textAlign: "left" }}
                    >
                      <span style={{ fontSize: 14, color: "rgb(89, 89, 89)" }}>
                        The creation,{" "}
                        <span style={{ fontSize: 14, color: "rgb(89, 89, 89)" }}>
                    ...
                    >
                      ...
                      >
                        <bdt data-type="conditional-block">
                          ...
                          />
                          <bdt data-type="body">
                            &nbsp;or making Contributions accessible to the Site
        ...
        <div align="center" style={{ textAlign: "left", lineHeight: "1.5" }}>
          ...
          <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              ...
              . <bdt classname="question">Living memory</bdt> and yourself
          ...
          <div align="center" style={{ textAlign: "left" }}>
            ...
            >
              ...
              >
                ...
                of the <bdt classname="block-component" />
                <bdt classname="question">Israel</bdt>
                <bdt classname="statement-end-if-in-editor" />
              </span>{" "}
              courts. <bdt classname="question">Living memory</bdt> shall also
                  ...
                  <strong>
                    ...
                    >
                      <bdt
                        ...
                        data-type="question"
                      >
                        <strong>goldnery@gmail.com</strong>
                      </bdt>
                    </span>
                  </strong>
                </strong>
